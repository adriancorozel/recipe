...
export function getClientSettings(): UserManagerSettings {
  return {
    ...
    scope: 'openid profile email digitalRecipePoc.read',
    filterProtocolClaims: true,
    loadUserInfo: true,
    automaticSilentRenew: true,
    silent_redirect_uri: 'http://localhost:4201/silent-signin-callback',
  };
}
export class OAuthConstants {
  public static clientRoot = 'http://localhost:4201';
  public static authority = 'http://localhost:5000';
  public static client_id = 'angular-digital-recipe';
}
